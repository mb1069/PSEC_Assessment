...
\begin{table}[h]
\centering
\begin{tabular}{|p{2cm}|p{1.25cm}|p{8cm}|p{2.5cm}|p{1.25cm}|}
\hline
\textbf{Type of threat origin} & \textbf{Origin of threat} & \textbf{Threat(s)} & \textbf{ISO Type} & \textbf{Origin} \\ \hline
{\textbf{Human (insider)}} & LV/PLV driver & Unauthorised use of equipment: lead driver does not follow itinerary, may endanger FV & Unauthorised action & A, D \\ \cline{2-5} 
 &  & Tampering with hardware/software, theft of equipment: LVD uses equipment for personal gain/mischief. & Compromise of information & A, D \\ \cline{3-5} 
 &  & position detection, disclosure of travel path: LVD reveals information which may lead to security compromise for FVDs &  &  \\ \cline{3-5} 
 & Driver of FV, PFV & Unauthorised use of equipment: lead driver does not follow platoon joining protocol, not paying attention to situation; this may lead to collisions between vehicles & Unauthorised action & A, D \\ \cline{2-5} 
 & Back office admin & Unauthorised use of equipment: abuse of PLV/PFV matching to maliciously guide vehiclesFraudulent copying of software for industrial espionageIllegal processing of data: abusing payment systems for company/personal gains & Unauthorised actions & A, D \\ \cline{3-5} 
 &  & Error in use, abuse of rights, denial of actions: BOA abuses vehicle matching by malicious intention/accident & Compromise of functions & A, D \\ \cline{2-5} 
...
{\textbf{Human (outsider)}} & Computer criminal & Denial of Actions: DDoS on Back Office systemTampering with software: Subversion of Back Office, (erroneous data about lead vehicle positions)Position detection/Disclosure of client vehicle dataRemote spying: (allow retrieval of lead vehicle routes for competitor)Spoofing of V2V communication: endanger following vehicles & Unauthorised actions, Compromise of information & D \\ \cline{2-5} 
...
\textbf{Vehicles} & LV / FV / PLV / PFV & Equipment failure/malfunction,Loss of power supply, all Physical damage types, all Natural events (eg climatic/seismic): resulting in damage to vehicle and/or other vehicles and environment & Physical damage, Loss of essential services, Natural events, dist. due to radiation & A, D, E \\ \hline
{\textbf{Technical infrastructure}} & V2V communication, V2I communication & Failure of telecommunication equipment or loss of power supply: unable to coordinate platoon forming/joining between vehicles & Loss of essential service, Natural events, Physical damage & A, D, E \\ \cline{2-5} 
