...
\begin{longtable}{|p{2cm}|p{1.5cm}|p{7cm}|p{3cm}|p{1cm}|}
\hline
...
\caption{Identified threats to the SARTRE system within the scope defined in \autoref{subsec:purpose_scope}}
\label{tab:threats}
\end{longtable}
