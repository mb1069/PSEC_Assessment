...
def main():
    ...
    victim_passwords = PasswordPicker(password_frequency_filename, password_len, 6).get_dict()
    attack_passwords = PasswordAttackList(dictionary_filename, password_len, 6).get_dict()
